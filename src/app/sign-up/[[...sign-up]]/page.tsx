    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-16">
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-slate-300 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/70 p-8 shadow-2xl shadow-black/40">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              <label htmlFor="firstName" className="text-xs font-semibold tracking-wide text-slate-600 dark:text-slate-300 uppercase">
                First name
              </label>
              <input
                id="firstName"
            ...
            <div className="space-y-2">
              <label htmlFor="lastName" className="text-xs font-semibold tracking-wide text-slate-600 dark:text-slate-300 uppercase">
                Last name
              </label>
              <input
                id="lastName"
        ...
        <p className="text-center text-xs text-slate-600 dark:text-slate-400">
          ...
          <a href="/sign-in" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300">
            Sign in
          </a>
        </p>
      </div>
