  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <div className="mx-auto max-w-7xl px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold text-slate-900 dark:text-white">Profile Overview</h1>
          <p className="text-slate-600 dark:text-slate-400">Manage your account and view your trading activity</p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              <h3 className="mb-4 text-lg font-semibold text-slate-900 dark:text-white">Trading Overview</h3>

              <div className="grid gap-4 md:grid-cols-3">
                {/* Total Trades */}
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950/50">
                  <div className="mb-1 text-sm text-slate-600 dark:text-slate-400">Total Trades</div>
                ...
                {/* Profit/Loss */}
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950/50">
                  <div className="mb-1 text-sm text-slate-600 dark:text-slate-400">Total P/L</div>
                  <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">$0.00</div>
                  <div className="mt-1 text-xs text-emerald-600 dark:text-emerald-400">+0.00%</div>
                </div>

                {/* Win Rate */}
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950/50">
                  <div className="mb-1 text-sm text-slate-600 dark:text-slate-400">Win Rate</div>
                  <div className="text-2xl font-bold text-slate-900 dark:text-white">0%</div>
                  <div className="mt-1 text-xs text-slate-500">No trades yet</div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="flex min-h-[200px] items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 dark:border-slate-700 dark:bg-slate-950/50">
                <div className="text-center">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">No trading activity yet</p>
                  <p className="mt-1 text-xs text-slate-500 dark:text-slate-500">Start trading to see your activity here</p>
                </div>
              </div>
            </div>
          </div>
