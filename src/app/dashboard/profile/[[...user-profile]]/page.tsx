...
export default function UserProfilePage() {
  return (
    <div className="mx-auto w-full max-w-3xl rounded-3xl border border-slate-800 bg-slate-900/60 p-6 shadow-2xl shadow-black/30">
      <header className="mb-6 space-y-1">
        <p className="text-xs tracking-[0.3em] text-slate-500 uppercase">
          Account
        </p>
        <h1 className="text-2xl font-semibold text-white">Profile (mock only)</h1>
      ...
      <form className="space-y-5">
        <div className="space-y-2">
          <label htmlFor="displayName" className="text-xs font-semibold tracking-[0.2em] text-slate-300 uppercase">
            Display name
          </label>
          <input
            id="displayName"
        ...
        <div className="space-y-2">
          <label htmlFor="email" className="text-xs font-semibold tracking-[0.2em] text-slate-300 uppercase">
            Contact email
          </label>
          <input
            id="email"
        ...
        <div className="space-y-2">
          <label htmlFor="timezone" className="text-xs font-semibold tracking-[0.2em] text-slate-300 uppercase">
            Trading timezone
          </label>
          <select
            id="timezone"
        ...
        <div className="space-y-2">
          <label htmlFor="risk" className="text-xs font-semibold tracking-[0.2em] text-slate-300 uppercase">
            Risk profile
          </label>
          <select
            id="risk"
